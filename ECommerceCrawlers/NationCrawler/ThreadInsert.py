...
if __name__ == '__main__':
    # with open('10w.txt',"w",encoding='utf-8-sig') as f:
    #     for i in range(0,100000):
    #         f.write('"1" "'+str(i)+'" "asin001" "shop001"\n')
    #     f.close()
    # with open('50w.txt', "w", encoding='utf-8-sig') as f:
    #     for i in range(0, 500000):
    #         f.write('"1" "'+str(i)+'" "asin001" "shop001"\n')
    #     f.close()
    # with open('100w.txt', "w", encoding='utf-8-sig') as f:
    #     for i in range(0, 1000000):
    #         f.write('"1" "'+str(i)+'" "asin001" "shop001"\n')
    #     f.close()
    # with open('500w.txt', "w", encoding='utf-8-sig') as f:
